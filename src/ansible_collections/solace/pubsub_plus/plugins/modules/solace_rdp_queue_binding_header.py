...
short_description: header on queue bindining on rdp
description:
...
class SolaceRdpQueueBindingHeaderTask(SolaceBrokerCRUDTask):
    ...
    def get_func(self, vpn_name, rdp_name, queue_name, header_name):
        # GET /msgVpns/{msgVpnName}/restDeliveryPoints/{restDeliveryPointName}/queueBindings/{queueBindingName}/requestHeaders/{headerName}
        path_array = [SolaceSempV2Api.API_BASE_SEMPV2_CONFIG, 'msgVpns',
                      vpn_name,
                      'restDeliveryPoints', rdp_name,
                      'queueBindings', queue_name,
                      'requestHeaders', header_name]
        return self.sempv2_api.get_object_settings(self.get_config(), path_array)

    def create_func(self, vpn_name, rdp_name, queue_name, header_name, settings=None):
        # POST /msgVpns/{msgVpnName}/restDeliveryPoints/{restDeliveryPointName}/queueBindings/{queueBindingName}/requestHeaders
        data = {
            'msgVpnName': vpn_name,
    ...
    def update_func(self, vpn_name, rdp_name, queue_name, header_name, settings=None, delta_settings=None):
        # PATCH /msgVpns/{msgVpnName}/restDeliveryPoints/{restDeliveryPointName}/queueBindings/{queueBindingName}/requestHeaders/{headerName}
        path_array = [SolaceSempV2Api.API_BASE_SEMPV2_CONFIG, 'msgVpns',
                      vpn_name,
                      'restDeliveryPoints', rdp_name,
                      'queueBindings', queue_name,
    ...
    def delete_func(self, vpn_name, rdp_name, queue_name, header_name):
        # DELETE /msgVpns/{msgVpnName}/restDeliveryPoints/{restDeliveryPointName}/queueBindings/{queueBindingName}/requestHeaders/{headerName}
        path_array = [SolaceSempV2Api.API_BASE_SEMPV2_CONFIG, 'msgVpns',
                      vpn_name, 'restDeliveryPoints', rdp_name,
                      'queueBindings', queue_name,
                      'requestHeaders', header_name]
...
def run_module():
    ...
    solace_task = SolaceRdpQueueBindingHeaderTask(module)
    solace_task.execute()
