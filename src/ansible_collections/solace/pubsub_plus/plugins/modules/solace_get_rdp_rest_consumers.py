...
short_description: get list of rdp rest consumers
description:
- "Get a list of Rest Consumer objects configured on a Rest Delivery Point object."
notes:
- "Module Sempv2 Config: https://docs.solace.com/API-Developer-Online-Ref-Documentation/swagger-ui/config/index.html#/restDeliveryPoint/getMsgVpnRestDeliveryPointRestConsumers"
- "Module Sempv2 Monitor: https://docs.solace.com/API-Developer-Online-Ref-Documentation/swagger-ui/monitor/index.html#/restDeliveryPoint/getMsgVpnRestDeliveryPointRestConsumers"
options:
  rdp_name:
...
class SolaceGetRdpRestConsumersTask(SolaceBrokerGetPagingTask):
    ...
    def get_path_array(self, params: dict) -> list:
        ...
        return ['msgVpns', params['msg_vpn'], 'restDeliveryPoints', params['rdp_name'], 'restConsumers']
