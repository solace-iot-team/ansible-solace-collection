...
short_description: get list of jndi topics
description:
- "Get a list of JNDI Topic objects."
notes:
- "Module Sempv2 Config: https://docs.solace.com/API-Developer-Online-Ref-Documentation/swagger-ui/config/index.html#/jndi/getMsgVpnJndiTopics"
- "Module Sempv2 Monitor: https://docs.solace.com/API-Developer-Online-Ref-Documentation/swagger-ui/monitor/index.html#/jndi/getMsgVpnJndiTopics"
...
class SolaceGetJNDITopicsTask(SolaceBrokerGetPagingTask):
...
def run_module():
    ...
    solace_task = SolaceGetJNDITopicsTask(module)
    solace_task.execute()
