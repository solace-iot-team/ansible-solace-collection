...
short_description: get list of client connect address exceptions on an acl profile
description:
- "Get a list of Client Connect Address Exception objects configured on an ACL Profile."
notes:
...
- "Module Sempv2 Monitor: https://docs.solace.com/API-Developer-Online-Ref-Documentation/swagger-ui/monitor/index.html#/aclProfile/getMsgVpnAclProfileClientConnectExceptions"
options:
  acl_profile_name:
...
class SolaceGetAclClientConnectExceptionsTask(SolaceBrokerGetPagingTask):
...
def run_module():
    ...
    solace_task = SolaceGetAclClientConnectExceptionsTask(module)
    solace_task.execute()
