...
class SolaceClientCertAuthorityTask(SolaceBrokerCRUDTask):
    ...
    def get_func(self, cert_authority_name):
        ...
        # GET /clientCertAuthorities/{certAuthorityName}
    ...
    def create_func(self, cert_authority_name, settings=None):
        ...
        # POST /clientCertAuthorities
        data = {
            self.OBJECT_KEY: cert_authority_name
        }
        data.update(settings if settings else {})
        path_array = [
            SolaceSempV2Api.API_BASE_SEMPV2_CONFIG, 'clientCertAuthorities']
    ...
    def update_func(self, cert_authority_name, settings=None, delta_settings=None):
        ...
        # PATCH /clientCertAuthorities/{certAuthorityName}
        path_array = [SolaceSempV2Api.API_BASE_SEMPV2_CONFIG,
                      'clientCertAuthorities', cert_authority_name]
    ...
    def delete_func(self, cert_authority_name):
        ...
        # DELETE /clientCertAuthorities/{certAuthorityName}
        path_array = [SolaceSempV2Api.API_BASE_SEMPV2_CONFIG,
                      'clientCertAuthorities', cert_authority_name]
