...
short_description: get list of trusted common names on a dmr cluster link
description:
...
class SolaceGetDmrClusterLinkTrustedCommonNames(SolaceBrokerGetPagingTask):
    ...
    def get_path_array(self, params: dict) -> list:
        # GET /dmrClusters/{dmrClusterName}/links/{remoteNodeName}/tlsTrustedCommonNames
        return ['dmrClusters', params['dmr_cluster_name'], 'links', params['remote_node_name'], 'tlsTrustedCommonNames']
