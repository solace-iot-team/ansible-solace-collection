...
short_description: get list of remote addresses on a dmr cluster link
description:
- "Get a list of Remote Address objects configured on a DMR Cluster Link object."
notes:
- "Module Sempv2 Config: https://docs.solace.com/API-Developer-Online-Ref-Documentation/swagger-ui/config/index.html#/dmrCluster/getDmrClusterLinkRemoteAddresses"
- "Module Sempv2 Monitor: https://docs.solace.com/API-Developer-Online-Ref-Documentation/swagger-ui/monitor/index.html#/dmrCluster/getDmrClusterLinkRemoteAddresses"
options:
  dmr_cluster_name:
