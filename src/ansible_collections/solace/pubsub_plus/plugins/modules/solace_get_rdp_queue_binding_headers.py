...
short_description: get list of headers on rdp queue binding
description:
...
class SolaceGetRdpQueueBindingHeadersTask(SolaceBrokerGetPagingTask):

    def __init__(self, module):
        super().__init__(module)

    def get_path_array(self, params: dict) -> list:
        # GET /msgVpns/{msgVpnName}/restDeliveryPoints/{restDeliveryPointName}/queueBindings/{queueBindingName}/requestHeaders
        return ['msgVpns', params['msg_vpn'], 'restDeliveryPoints', params['rdp_name'], 'queueBindings', params['queue_name'], 'requestHeaders']
...
def run_module():
    ...
    solace_task = SolaceGetRdpQueueBindingHeadersTask(module)
    solace_task.execute()
