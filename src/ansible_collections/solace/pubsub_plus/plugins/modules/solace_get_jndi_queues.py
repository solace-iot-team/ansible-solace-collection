...
short_description: get list of jndi queues
description:
- "Get a list of JNDI Queue objects."
notes:
- "Module Sempv2 Config: https://docs.solace.com/API-Developer-Online-Ref-Documentation/swagger-ui/config/index.html#/jndi/getMsgVpnJndiQueues"
- "Module Sempv2 Monitor: https://docs.solace.com/API-Developer-Online-Ref-Documentation/swagger-ui/monitor/index.html#/jndi/getMsgVpnJndiQueues"
...
class SolaceGetJNDIQueuesTask(SolaceBrokerGetPagingTask):
...
def run_module():
    ...
    solace_task = SolaceGetJNDIQueuesTask(module)
    solace_task.execute()
