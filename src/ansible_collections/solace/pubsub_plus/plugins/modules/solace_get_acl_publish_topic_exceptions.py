...
short_description: get list of publish topic exceptions on an acl profile
description:
- "Get a list of Publish Topic Exception objects configured on an ACL Profile."
notes:
- "Module Sempv2 Config: https://docs.solace.com/API-Developer-Online-Ref-Documentation/swagger-ui/config/index.html#/aclProfile/getMsgVpnAclProfilePublishTopicExceptions"
- "Module Sempv2 Monitor: https://docs.solace.com/API-Developer-Online-Ref-Documentation/swagger-ui/monitor/index.html#/aclProfile/getMsgVpnAclProfilePublishTopicExceptions"
options:
  acl_profile_name:
...
class SolaceGetAclPublishTopicExceptionsTask(SolaceBrokerGetPagingTask):

    def __init__(self, module):
        super().__init__(module)

    def get_path_array(self, params: dict) -> list:
        # GET /msgVpns/{msgVpnName}/aclProfiles/{aclProfileName}/publishTopicExceptions
...
def run_module():
    ...
    solace_task = SolaceGetAclPublishTopicExceptionsTask(module)
    solace_task.execute()
