...
# Environment Variables
  ...
  if [ -z "$INVENTORY_FILE" ]; then echo ">>> XT_ERROR: - $scriptLogName - missing env var: INVENTORY_FILE"; exit 1; fi
  ...
  else echo ">>> XT_ERROR: - $scriptLogName - unknown BROKER_TYPE=$BROKER_TYPE"; exit 1; fi
