...
playbooks=(
  "$scriptDir/jndi-connection-factory.playbook.yml"
  "$scriptDir/jndi-connection-factory.doc-example.playbook.yml"

  "$scriptDir/jndi-queue.playbook.yml"
  "$scriptDir/jndi-queue.doc-example.playbook.yml"
  "$scriptDir/jndi-queue-list.playbook.yml"
  "$scriptDir/jndi-queue-list.doc-example.playbook.yml"

  "$scriptDir/jndi-topic.playbook.yml"
  "$scriptDir/jndi-topic.doc-example.playbook.yml"
  "$scriptDir/jndi-topic-list.playbook.yml"
  "$scriptDir/jndi-topic-list.doc-example.playbook.yml"
)
